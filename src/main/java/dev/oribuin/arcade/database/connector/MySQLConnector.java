package dev.oribuin.arcade.database.connector;
...
public class MySQLConnector implements DatabaseConnector {
    ...
    public MySQLConnector(ArcadePlugin javaPlugin, String hostname, int port, String database, String username, String password, boolean useSSL, int poolSize) {
        ...
        try {
            ...
            this.javaPlugin.getLogger().severe("Failed to connect to the MySQL server. Are your credentials correct?");
            ex.printStackTrace();
        }
    }
    ...
    public void connect(ConnectionCallback callback) {
        ...
        try (Connection connection = this.hikari.getConnection()) {
            ...
            this.javaPlugin.getLogger().severe("An error occurred executing a MySQL query: " + ex.getMessage());
            ex.printStackTrace();
        } finally {

...
public class SQLiteConnector implements DatabaseConnector {
    ...
    public SQLiteConnector(ArcadePlugin javaPlugin) {
        this(javaPlugin, ArcadePlugin.getInstance().getName().toLowerCase());
    }

    public SQLiteConnector(ArcadePlugin javaPlugin, String dbName) {

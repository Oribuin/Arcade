package dev.oribuin.arcade.scheduler;

import dev.oribuin.arcade.ArcadePlugin;
import dev.oribuin.arcade.scheduler.task.ScheduledTask;
import dev.oribuin.arcade.scheduler.wrapper.BukkitSchedulerWrapper;
import dev.oribuin.arcade.scheduler.wrapper.FoliaSchedulerWrapper;
...
public class PluginScheduler implements SchedulerWrapper {
    ...
    private PluginScheduler(ArcadePlugin javaPlugin) {
        if (instance != null)
    ...
    public static PluginScheduler get() {
        if (instance == null) {
            instance = new PluginScheduler(ArcadePlugin.getInstance());
        }
        return instance;
    }

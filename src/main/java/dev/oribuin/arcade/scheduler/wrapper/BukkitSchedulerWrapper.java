package dev.oribuin.arcade.scheduler.wrapper;

import dev.oribuin.arcade.ArcadePlugin;
import dev.oribuin.arcade.scheduler.task.BukkitScheduledTask;
import dev.oribuin.arcade.scheduler.task.ScheduledTask;
import dev.oribuin.arcade.util.math.NumberUtil;
...
public class BukkitSchedulerWrapper implements SchedulerWrapper {
    ...
    public BukkitSchedulerWrapper(ArcadePlugin javaPlugin) {

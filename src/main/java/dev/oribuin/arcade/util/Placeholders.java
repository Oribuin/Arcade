...
public final class Placeholders {
    ...
    private Placeholders(Map<String, Component> placeholders) {
        ...
        this.resolvers = ArcadeUtils.RESOLVER;
    }
    ...
    public Component apply(String string) {
        ...
        return ArcadeUtils.MINIMESSAGE.deserialize(string, builder.build())
    ...
    public String applyString(String string) {
        return ArcadeUtils.PLAIN.serialize(this.apply(string));
    }
